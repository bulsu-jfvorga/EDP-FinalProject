...
public class FilteredPostPanel {

    private final String filterType;
    private final String titleText;

    // Constants (replace with your actual values or pass them in constructor)
    private final String BG = "#F5F5F5";       // Background color
    private final String CARD = "#FFFFFF";     // Card background
    private final String PRIMARY = "#800000";  // Maroon
    private final String ACCENT = "#FFD700";   // Gold

    public FilteredPostPanel(String filterType, String titleText) {
    ...
    public ScrollPane getPanel() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            while (rs.next()) {
                VBox postCard = createPostCard(rs);
    ...
    private VBox createPostCard(ResultSet rs) throws Exception {
