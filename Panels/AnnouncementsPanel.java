...
public class AnnouncementsPanel extends VBox {
    ...
    public AnnouncementsPanel() {
        VBox panelContent = createFilteredPostPanel("announcement", "Announcements Page");
    ...
    private VBox createFilteredPostPanel(String filterType, String titleText) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            while (rs.next()) {
                ...
                postCard.setStyle("-fx-background-color: " + CARD + "; -fx-background-radius: 15; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.15), 15, 0, 0, 10);");
                ...
                typeTag.setStyle("-fx-background-color: " + PRIMARY + "; -fx-text-fill: " + ACCENT + "; -fx-font-weight: bold; -fx-font-size: 11px; -fx-padding: 4 12; -fx-background-radius: 5;");
                ...
                sourceLbl.setStyle("-fx-text-fill: " + PRIMARY + "; -fx-font-weight: bold;");
